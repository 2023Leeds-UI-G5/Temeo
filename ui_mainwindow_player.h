...
public:
    ...
    void setupUi(QMainWindow *MainWindow_player)
    {
        ...
        pushButton_like->setGeometry(QRect(40, 120, 32, 26));
        ...
        pushButton_share->setGeometry(QRect(770, 120, 32, 26));
        ...
        pushButton_sendcomment->setGeometry(QRect(700, 50, 101, 51));
        QFont font;
        ...
        pushButton_self->setGeometry(QRect(30, 50, 52, 51));
...
"}"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/new/icons/src/account.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_self->setIcon(icon2);
        ...
        pushButton_collect->setGeometry(QRect(90, 120, 32, 26));
        pushButton_collect->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/new/icons/src/collect.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon3.addFile(QString::fromUtf8(":/new/icons/src/collected.png"), QSize(), QIcon::Normal, QIcon::On);
        pushButton_collect->setIcon(icon3);
        ...
        textEdit_comment->setGeometry(QRect(110, 50, 541, 51));
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/new/icons/src/languageEnglish.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon4.addFile(QString::fromUtf8(":/new/icons/src/languageChinese.png"), QSize(), QIcon::Normal, QIcon::On);
        pushButton_language->setIcon(icon4);
        ...
        pushButton_selficon->setIcon(icon2);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/new/icons/src/like.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_likelist->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/new/icons/src/collect.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_collection->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/new/icons/src/screenshot.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_screenshotlibrary->setIcon(icon7);
        ...
        pushButton_screenshot->setIcon(icon7);
